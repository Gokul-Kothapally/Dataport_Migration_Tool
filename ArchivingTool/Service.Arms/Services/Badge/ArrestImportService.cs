...
ImportArrestAsync(
    ...
    Guid agencyKey = default)
        {
            if (arrestJson == null || arrestJson.Count == 0)
            ...
            try
            {
                ...
                var json = JsonConvert.SerializeObject(arrestJson);
                var content = new StringContent(json, Encoding.UTF8, "application/json");

                var requestModel = new CommonRequestModel
                {
                    Endpoint = "Document/Arrests",
